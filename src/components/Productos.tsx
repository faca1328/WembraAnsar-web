                                                ...
                                                <div class="relative p-4 w-full h-full m-auto top-24 max-w-2xl animate-fade-down transition-all animate-duration-300">
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b">
                                                            <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">I accept</button>
